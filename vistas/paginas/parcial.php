...
<div class="container">
	<h2>Ingresa datos de cliente en parcialidades</h2>
	<form method="post">
		...
		<div class="d-flex py-5 p-5">
			<div class="form-group p-5">
				<input type="checkbox"  id="INEParcialFosa3" name="INEParcialFosa3" required>
				<label for="INE">Copia del INE</label>
			</div>

			<div class="form-group p-5">
				<input type="checkbox"  id="ComprobanteDomParcialFosa3" name="ComprobanteDomParcialFosa3" required>
				<label for="ComprobanteDom">Copia del comprobante de dommicilio</label>
			</div>

			<div class="form-group p-5">
				<input type="checkbox"  id="INEAvalFosa3" name="INEAvalFosa3" required>
				<label for="INE">Copia del INE del Aval</label>
			</div>

			<div class="form-group p-5">
				<input type="checkbox"  id="ComprobanteDomAvalFosa3" name="ComprobanteDomAvalFosa3" required>
